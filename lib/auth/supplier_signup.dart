...
class SupplierSignup extends StatefulWidget {
  ...
  @override
  State<SupplierSignup> createState() => _CustomerSignupState();
}

class _CustomerSignupState extends State<SupplierSignup> {
    ...
    if (_formKey.currentState!.validate()) {
      if (image != null) {
        try {
          ...
          try{
          f_storage.Reference reference=f_storage.FirebaseStorage.instance.ref("supp-images/$email.jpg");
          await reference.putFile(File(image!.path));
          storeImageUrl=await reference.getDownloadURL();
          }
          ...
          try{
            await FirebaseFirestore.instance.collection("suppliers").doc(FirebaseAuth.instance.currentUser!.uid).set({
            "name":storeName,
            "email":email,
            "profile_image":storeImageUrl,
            "cover_image":"",
            "phone":"",
